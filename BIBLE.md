...
| Recall/absence บนคู่ที่ตรวจมือ 47 คู่ (ก่อน c733acc → หลัง HEAD) | KEEP-recall 97.5% → **100%** · CUT-absence **100%** ทั้งสอง |
| ความแม่นยำของความสัมพันธ์จาก WordNet (สุ่มตรวจ 120 คู่จริง) | **84.2%** (Confirmed tier 85.1%, Unverified tier 81.8%) — ครอบคลุมเฉพาะชั้น WordNet ที่แสดง (1-hop) |
